        ...
        <div id="contenido" class="container p-4">
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <form action="procesar_vetAdmin.php" name="" method="POST" enctype="multipart/form-data">
                    <h5>INGRESAR Veterinarios:</h5>
                                ...
                                <?php 
                                    ...
                                    while ( $row = mysqli_fetch_array($result_tarea)){ ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="editarVet.php?id=<?php echo $row['id']?>" class="btn btn-secondary">
                                                    <i class="fas fa-marker"></i> <!-- editar-->
                                                    </a> <br>
                                                    <a href="eliminarVet.php?id=<?php echo $row['id']?>" class="btn btn-danger">
