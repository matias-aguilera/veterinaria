        ...
        <div id="contenido" class="container p-4">
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <form action="procesar_perAdmin.php" name="" method="POST" enctype="multipart/form-data">
                                ...
                                <?php 
                                    ...
                                    while ( $row = mysqli_fetch_array($result_tarea)){ ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="editarPersona.php?id=<?php echo $row['id']?>" class="btn btn-secondary">
                                                    <i class="fas fa-marker"></i> <!-- editar-->
                                                    </a> <br>
                                                    <a href="eliminarPersona.php?id=<?php echo $row['id']?>" class="btn btn-danger">
